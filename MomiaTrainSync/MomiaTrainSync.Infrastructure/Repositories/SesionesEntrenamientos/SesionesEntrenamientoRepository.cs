...
{
    public class SesionesEntrenamientoRepository : GenericRepository<SesionEntrenamientoEnt>, ISesionesEntrenamientoRepository
    {
        public SesionesEntrenamientoRepository(
