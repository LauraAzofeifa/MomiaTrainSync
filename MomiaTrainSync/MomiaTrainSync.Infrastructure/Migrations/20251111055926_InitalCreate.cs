        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { -2, "Trainer", "GESTIONAR_ATLETAS", "Permite gestionar atletas", true, "/Trainer/ManageAthletes" },
                    { -1, "Admin", "GESTIONAR_USUARIOS", "Permite administrar usuarios del sistema", true, "/Admin/ManageUsers" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { -3, "Usuario que recibe rutinas asignadas", "Atleta" },
                    { -2, "Gestiona rutinas, entrenamientos y atletas", "Entrenador" },
